...
│── /models                 # Face-api models (if included/downloaded)
│── /assets                 # UI assets (icons/images if present)
│── /scripts or inline JS   # Core logic (face recognition + attendance)
...
Rohit Joshi
GitHub: https://github.com/rohit-joshi-01
